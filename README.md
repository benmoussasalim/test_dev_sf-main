...
1. Que mettriez-vous en place afin d'améliorer les temps de réponses du script => faire la mise en cache des reponses des API pour accelerer le traitement.
2. Comment aborderiez-vous le fait de rendre scalable le script (plusieurs milliers de sources et images) => On creer une commande Symfony qui tourne en amont et qui extrait les données des apis
